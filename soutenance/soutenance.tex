...
\begin{frame}
    ...
    % Cette fonction est basée sur l'expérience du robot, acquise de manière aléatoire. Je vais caractériser cette expérience par un catalogue, qui contient une liste de commande et des effets associés
...
\begin{frame}
    ...
    % J'ai choisi le Master AVR par passion pour les matières qui y sont enseginées, et pour découvrir le monde de la recherche. Je suis donc satisfait de ce stage, avec un sujet et un robot que je trouve intéressant.
