...
\begin{frame}
    ...
    %Logo loria
    % \begin{tikzpicture}[remember picture,overlay]
    %     \node[xshift=0.5\textwidth,yshift=-76mm,anchor=north west] at (current page.north west){%
    %         \includegraphics[width=100pt]{logo_loria_complet.jpg}
    %     };
    % \end{tikzpicture}
\end{frame}
...
\begin{frame}
    ...
    \center
    \includegraphics[width=.7\textwidth]{contexte.png}

    % On donne une cible à un robot dans le monde réel, on ne connait pas naturellement quel commande à lui envoyer pour atteindre cette cible.
...
\begin{frame}
    ...
    \begin{tabular}{m{0.60\textwidth} m{0.35\textwidth}}
...
\begin{frame}
    ...
    \begin{tabular}{m{0.4\textwidth} m{0.5\textwidth}}
        ...
        % Todo : représenter interpolation
...
\begin{frame}
    ...
    \begin{tabular}{m{.45\textwidth} m{.3\textwidth}}
