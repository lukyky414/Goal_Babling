...
if options.learning:
    ...
    if options.use_file:
        ...
        nn = my_nearest_neighbor.RtreeNeighbor(save_load=False, name=None)
...
#Partie Analyse
if options.analyse is not None:
    name = options.analyse
    nn = my_nearest_neighbor.RtreeNeighbor(save_load=False, name=name)
