...
Sur la figue \ref{fig:MB_dis_moy_ik}, il y aussi une différence très significative. Cela confirme que plus d'entrées dans la base donnent une distance moyenne entre résultat et but plus petite donc une meilleure précision.

\begin{figure}[h]
    \centering
    \includegraphics[width=178pt]{1mb_1k-100kstep_moy_ik.png}
    \caption{Distance moyenne des observations à la liste Ikpy pour 1000 et 100 000 entrées.}
    \label{fig:MB_dis_moy_ik}
\end{figure}
