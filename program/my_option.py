...
def get_options_learn():
    ...
    parser.add_argument("--pp", 
                        ...
                        type=pos_float,
                        default=0.05,
                        help= "Posture perturbation, in proportion of each motor limits, default=0.05"
    )
...
def get_options_analyse():
    parser = argparse.ArgumentParser(description='Analysing the catalog of the Inverse Model.')

    parser.add_argument("file",
                        type=str,
                        default=None,
                        help="File generated by the step 1."
    )
    parser.add_argument("--nb_div", 
                        dest="nb_div",
                        type=pos_int,
...
def get_options_summary():
    parser = argparse.ArgumentParser(description='Sum up informations on all analysis results of one learning.')

    parser.add_argument("file",
                        type=str,
                        default=None,
                        help="File generated by the step 3."
    )
    parser.add_argument("--debug", 
                        dest="debug",
                        action='store_true',
